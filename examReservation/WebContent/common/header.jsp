			...
			<div class="col-md-12">
				<nav class="navbar navbar-inverse navbar-fixed-top" >
					...
					<ul class="nav navbar-nav navbar-right" style="margin-right:100px">
						...
						<li>
							<a href="../administrator/admin.jsp" class="btn"><span class="glyphicon glyphicon-user"></span>&nbsp;当前用户:&nbsp;<span class="text-info" id="currUser">${sessionScope.user.aname }</span></a>
						</li>
					</ul>
				</nav>
			</div>
